...
namespace Licitaciones.Infrastructure.Persistencia.Migraciones
{
    ...
    [Migration("20260812012346_AgregarRestriccionesCheckMontos")]
    partial class AgregarRestriccionesCheckMontos
    {
        /// <inheritdoc />
                    ...
                    b.ToTable("niveles_aprobacion", null, t =>
                        {
                            ...
                            t.HasCheckConstraint("CK_niveles_aprobacion_rango_valido", "\"MontoMaximoCRC\" IS NULL OR \"MontoMaximoCRC\" > \"MontoMinimoCRC\"");
                        });
            ...
            modelBuilder.Entity("Licitaciones.Domain.Entidades.TipoCambio", b =>
                {
                    ...
                    b.ToTable("tipos_cambio", null, t =>
                        {
                            t.HasCheckConstraint("CK_tipos_cambio_tasa_positiva", "\"CRCporUSD\" > 0");
                        });
